  ...
  Map<String, Map<String, String>> get keys {
    return {
      'en': {
        ...
        'backgroundRunningTitleMustRun': 'Minima must run in the background',
        'backgroundRunningBigTitle': 'Background running',
        'backgroundRunningBigTitleAreYouSure': 'Are you sure?',
        'backgroundRunningExplanation2': 'Are you still sure you want to skip this stage?',
        ...
        'incentiveCashScreenIncentiveCashProgramExplanation': "If you need to find your Incentive ID again, please use the button below.",
        ...
        'inviteCodeExplanation': '<b>Your Invite Link enables you to earn additional Rewards for inviting others to run a node and join the Incentive Program.</b><p>Once the Minima network reaches one million nodes, your Invite Link will no longer be active.',
        'inviteCodeExplanationCodeEntered': '<b>Your Invite Link enables you to earn additional Rewards for inviting others to run a node and join the Incentive Program.</b><p>Once the Minima network reaches one million nodes, your Invite Link will no longer be active.<p>In order to receive your Invite Code, you must connect your Incentive ID to your node using the Incentive Program tab above.',
