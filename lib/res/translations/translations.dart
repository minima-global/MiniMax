  ...
  Map<String, Map<String, String>> get keys {
    return {
      'en': {
        ...
        'inviteCodeExplanationCodeEntered': '<b>Your Invite Link enables you to earn additional Rewards for inviting others to run a node and join the Incentive Program.</b><p>Once the Minima network reaches one million nodes, your Invite Link will no longer be active.',
        'inviteCodeExplanation': '<b>Your Invite Link enables you to earn additional Rewards for inviting others to run a node and join the Incentive Program.</b><p>Once the Minima network reaches one million nodes, your Invite Link will no longer be active.<p>In order to receive your Invite Link, you must connect your Incentive ID to your node using the Incentive Program tab above.',
        'inviteCodeHint': 'Join Incentive Program to get Invite Link',
