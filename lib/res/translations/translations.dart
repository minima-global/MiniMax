    ...
    return {
      'en': {
        ...
        'batterySettingsExplanation':
            'To fully validate and secure the Minima blockchain, the Minima protocol needs to run in the background.<p>Please grant permission by clicking confirm.<p>If you do not wish to do this now, you can change this setting later by choosing Battery Optimization from the Options menu in the app.',
        ...
        'incentiveExplanationText':
            'Minima is currently in ‘Beta’ test net.<p>We are running an Incentive program for you to get Minima coins for running the app until we launch at main net.<p><b>To claim your existing rewards and to earn future daily rewards, be sure to set up your account on the Incentive Program page.</b>',
