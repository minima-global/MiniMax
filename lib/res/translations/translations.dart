  ...
  Map<String, Map<String, String>> get keys {
    return {
      'en': {
        ...
        'inviteCodeMessageToCopyToClipboard': 'Hello, if you join me in running a Minima node, you can earn Rewards until the network launches!\n\nRegister for their Incentive Program and get your node set up using my Invite link:\nhttps://incentive.minima.global/account/register?inviteCode=%s\n\nOnce you\'re set up, join the community and say hello 😊: https://discord.gg/minima',
        ...
        'terminalScreenWarning': '<b>Please do not copy and paste your logs into Minima’s public channels.</b><p>If you need help, please head to #support on our Discord so we can help you independently.<p>Thanks for your cooperation. 🙏',
