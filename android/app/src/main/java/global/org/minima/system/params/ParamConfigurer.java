package global.org.minima.system.params;
...
import static global.org.minima.system.params.ParamConfigurer.ParamKeys.toParamKey;
...
public class ParamConfigurer {
    ...
    enum ParamKeys {
        ...
        data("data", "Specify the data folder (absolute) (defaults to .org.minima/ under user home", (args, configurer) -> {
